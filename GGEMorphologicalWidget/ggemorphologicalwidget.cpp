#include "ggemorphologicalwidget.h"
#include "locale.h"
#include <QVector2D>
/****************************************************************************/
/****************************************************************************/
...
void GGEOpenGLWidget::initializeGL()
{
    ...
    filter.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/GGEMorphologicalWidget.vert");
    filter.addShaderFromSourceFile(QOpenGLShader::Geometry, ":/shaders/ggehistcalc.geom");
    filter.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/GGEMorphologicalWidget.frag");
    filter.link();

    program.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/GGEMorphologicalWidget.vert");
    program.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/GGEMorphologicalWidget.frag");
    program.link();
    setlocale(LC_ALL, "");
...
/****************************************************************************/
/****************************************************************************/
GGEMorphologicalWidget::GGEMorphologicalWidget(LAUMemoryObject image, QWidget *parent) : QWidget(parent), isValidFlag(false), label(NULL)
{
    ...
    if (image.isNull()) {
        QSettings settings;
        QString directory = settings.value(QString("GGEMorphologicalWidget::lastDirectory"), QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation)).toString();;
        ...
        if (filename.isEmpty() == false) {
            ...
            settings.setValue(QString("GGEMorphologicalWidget::lastDirectory"), string);
...
/****************************************************************************/
/****************************************************************************/
GGEMorphologicalWidget::~GGEMorphologicalWidget()
{
    ;
}
...
/****************************************************************************/
/****************************************************************************/
void GGEMorphologicalWidget::resizeEvent(QResizeEvent *)
{
...
/****************************************************************************/
/****************************************************************************/
void GGEMorphologicalDialog::resizeEvent(QResizeEvent *)
{
    if (widget) {
